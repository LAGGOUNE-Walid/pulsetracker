...
return [
     ...
     */
    'site_name' => 'Pulsetracker - realtime location tracking for developers',
     ...
     */
    'favicon' => url('/assets/img/Circle_Brand_Identity__Copy_-removebg-preview.png'),
    ...
    'image' => [
         ...
         */
        'fallback' => url('/assets/img/Circle_Brand_Identity__Copy_-removebg-preview.png'),
    ],
