...
<body style="background: black;border-color: var(--bs-body-bg);margin: 0px;">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6"><img
                ...
                <h4 style="color: var(--bs-gray-500);margin-top: 5%;">Already have an account?&nbsp;<a
                        href="{{ url('signin') }}">Login</a>&nbsp;</h4>
                <form style="margin-top: 8%;" method="POST" action="{{ url('account/create') }}">
                    @if ($errors->any())
                    ...
                    <div class="cf-turnstile mt-3" data-sitekey="{{ config('services.cloudflare.turnstile.site_key') }}"
                        data-callback="onTurnstileSuccess">
                    </div>


                    <button class="btn btn-outline-success btn-lg" type="submit" style="margin-top: 5%;width: 100%;"
                        disabled>Create acccount</button>
                </form>
                <hr style="margin-top: 5%;">
                <div class="row text-center">
                    <div class="col"><a class="btn btn-dark btn-lg" href="{{ url('login/github') }}" type="button"
                    ...
                    <div class="col"><a class="btn btn-dark btn-lg" href="{{ url('login/google') }}" type="button"
                            style="margin-top: 5%;"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
    ...
    <script>
        window.onTurnstileSuccess = function(code) {
            console.log("success onTurnstileSucces");
