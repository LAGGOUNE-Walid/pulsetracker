<footer class="text-center" style="margin-top: 8%;">
    <div class="container text-white py-4 py-lg-5">
        ...
        <h6><p class="text-muted mb-0"><small>Copyright © {{now()->year}} Pulsetracker &nbsp; &nbsp; <a href="https://x.com/ThePulsetracker"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
