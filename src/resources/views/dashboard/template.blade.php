...
<head>
    ...
    <script src="https://js-de.sentry-cdn.com/edf86eb6486765d336450b383fdd60b0.min.js" crossorigin="anonymous"></script>
</head>
            ...
            <div class="col-xl-2 col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark"
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100"
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li style="margin-top: 10%;"><a href="{{ url('docs/api') }}"
                                class="@if (Request::is('docs/api*')) selected @endif nav-link px-0 align-middle"><span
                                    class="ms-1 d-none d-sm-inline"><svg xmlns="http://www.w3.org/2000/svg"
