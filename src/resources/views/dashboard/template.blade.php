...
<body style="--bs-body-bg: black;background: black;">
    ...
    @if ($left <= 0)
        <div class="alert alert-warning text-center" style="border-radius: 0px;" role="alert">
            You have exceeded your quota. Please <a href="{{ url('/#pricing') }}">upgrade</a> your plan.
        </div>
    @endif
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100"
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item"><a href="{{ url('dashboard') }}"
                                class="@if (Request::is('dashboard')) selected @endif nav-link align-middle px-0"><svg
                        ...
                        <li class="nav-item"><a href="{{ url('dashboard/apps') }}"
                                class="@if (Request::is('dashboard/apps*')) selected @endif nav-link align-middle px-0"><svg
                        ...
                        <li style="margin-top: 10%;"><a href="{{ url('dashboard/devices') }}"
                                class="@if (Request::is('dashboard/devices*')) selected @endif nav-link px-0 align-middle"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                        ...
                        <li style="margin-top: 10%;"><a href="{{ url('dashboard/map') }}"
                                class="@if (Request::is('dashboard/map*')) selected @endif nav-link px-0 align-middle"><span
                        ...
                        <li style="margin-top: 10%;"><a href="{{ url('https://docs.pulsestracker.com') }}"
                                class="@if (Request::is('https://docs.pulsestracker.com*')) selected @endif nav-link px-0 align-middle"><span
                                    class="ms-1 d-none d-sm-inline"><svg xmlns="http://www.w3.org/2000/svg"
