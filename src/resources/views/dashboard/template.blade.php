...
<body style="--bs-body-bg: black;background: black;">
    ...
    @if (!auth()->user()->email_verified_at)
        <div class="alert alert-warning text-center" style="border-radius: 0px;" role="alert">
            Please activate your email, verify your inbox or <a href="{{ url('dashboard/send-now-verification') }}">send now</a> (1 mail per 10min)
        </div>
    @endif
                    ...
                    style="background: black;margin: 5%;"><a href="/"
                        class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none"><span
                            class="fs-5 d-none d-sm-inline">PulseTracker&nbsp;<img
                                src="assets/img/Circle%20Brand%20Identity.jpeg"
                                style="width: 50px;height: 50px;"></span></a><!-- Start: UL -->
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        id="menu" style="margin-top: 10%;">
                        <li class="nav-item"><a href="#" class="nav-link align-middle px-0"><svg
                        ...
                        <li style="margin-top: 10%;"><a href="#" class="nav-link px-0 align-middle"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                        ...
                        <li style="margin-top: 10%;"><a href="#submenu2" data-bs-toggle="collapse"
                                class="nav-link px-0 align-middle"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                </svg><span class="ms-1 d-none d-sm-inline">Map</span></a>
                            <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                                <li class="w-100"><a href="#" class="nav-link px-0"><span
                                            class="d-none d-sm-inline">Item</span></a></li>
                                <li><a href="#" class="nav-link px-0"><span
                                            class="d-none d-sm-inline">Item</span></a></li>
                            </ul>
                        </li>
                        <li style="margin-top: 10%;"><a href="#submenu3" data-bs-toggle="collapse"
                                class="nav-link px-0 align-middle"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                                ...
                                </svg><span class="ms-1 d-none d-sm-inline">Account / settings</span></a>
