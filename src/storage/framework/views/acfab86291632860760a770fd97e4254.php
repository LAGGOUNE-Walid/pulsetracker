    ...
    <div class="container" style="margin-top: 5%;">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6"><img
                ...
                <form style="margin-top: 8%;" method="POST" action="<?php echo e(url('account/login')); ?>">
                    <?php if($errors->any()): ?>
                ...
                <div class="row text-center">
                    <div class="col"><a class="btn btn-dark btn-lg" type="button" href="<?php echo e(url('login/github')); ?>"
                    ...
                    <div class="col"><a class="btn btn-dark btn-lg" type="button" href="<?php echo e(url('login/google')); ?>"
                            style="margin-top: 5%;"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
...
<?php /**PATH /var/www/html/resources/views/signin.blade.php ENDPATH**/ ?>