                    ...
                    <div class="col-md-12">
                        <div class="text-white p-4 p-md-5">
                            ...
                            <p>As a user, you have the right to access, modify, or delete your personal data. You may
                                also opt out of certain features or request data deletion by <a
                                    href="mailto:contact@pulsestracker.com">contacting us</a>. Please note
                                that requests may take up to 7 days to process. <br/>
                                We use Stripe for payments. Stripe retains a copy of all the data provided as part of a payment. You may also have consented to allow Stripe to use your data to improve their technology. You can delete your information from Stripe’s servers or revoke your consent by visiting https://support.stripe.com.
                                </p>
                            <br/>
                            ...
                            <p>We use umami, which is privacy-focused and does not use cookies or track personal
                                ...
                                Pulsetracker at this time, we only use session cookies.</p>
                            <br/>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/privacy-policy.blade.php ENDPATH**/ ?>