...
<body style="background: black;border-color: var(--bs-body-bg);margin: 0px;">
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active" href="<?php echo e(url('/')); ?>"><svg
    ...
    <div class="container" style="margin-top: 5%;">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6"><img
                ...
                <h1 style="margin-top: 5%;">Create a Pulsetracker account</h1>
                <h4 style="color: var(--bs-gray-500);margin-top: 5%;">Already have an account?&nbsp;<a
                        href="<?php echo e(url('signin')); ?>">Login</a>&nbsp;</h4>
                <form style="margin-top: 8%;" method="POST" action="<?php echo e(url('account/create')); ?>">
                    <?php if($errors->any()): ?>
                    ...
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="input-group"><input class="form-control" type="email" required
                ...
                <div class="row text-center">
                    <div class="col"><a class="btn btn-dark btn-lg" href="<?php echo e(url('login/github')); ?>" type="button"
                            ...
                            </svg>&nbsp;Sign up with Github</a></div>
                    <div class="col"><a class="btn btn-dark btn-lg" href="<?php echo e(url('login/google')); ?>" type="button"
                            style="margin-top: 5%;"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                ...
                <h5 style="margin-top: 5%;color: var(--bs-gray-500);">By signing up, you agree to our <a
                        href="<?php echo e(url('terms-of-use')); ?>" target="_blank">terms</a>, <a
                        href="<?php echo e(url('privacy-policy')); ?>" target="_blank">privacy policy</a>.</h5>
            </div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/signup.blade.php ENDPATH**/ ?>